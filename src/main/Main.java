...
public class Main {
	...
	public static void main(String args[]){
		...
		if( (args.length == 13 && args[0].equals("-wator")) ||(args.length == 9 && args[0].equals("-billes"))|| (args.length == 7 && args[0].equals("-pacman")) ){
		...
		fx.run(args);
			...
			System.out.println("Exemple d'options : main -billes   100      10 0      3     100     true      true     true   0");
			...
			System.out.println("Error nb argument : main -pacman nbChasseur nbMur  taille  tAgent torique seed	");
			System.out.println("Exemple d'options : main -pacman   10        500    100       3     true   	0	");
